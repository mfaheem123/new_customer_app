...
//
//     final bookingScheduleModel = bookingScheduleModelFromJson(jsonString);

import 'dart:convert';

BookingScheduleModel bookingScheduleModelFromJson(String str) => BookingScheduleModel.fromJson(json.decode(str));

String bookingScheduleModelToJson(BookingScheduleModel data) => json.encode(data.toJson());

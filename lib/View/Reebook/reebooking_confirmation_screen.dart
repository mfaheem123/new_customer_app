...
class ReeBookingConfirmationScreen extends StatefulWidget {
  ReeBookingConfirmationScreen({super.key});


  @override
  State<ReeBookingConfirmationScreen> createState() => _ReeBookingConfirmationScreen();
}

class _ReeBookingConfirmationScreen extends State<ReeBookingConfirmationScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<BookingController>(
      builder: (controller) {
        ...
        if (controller.reBookingData == null) {
          return  Scaffold(
            body: Container(
        ...
        final booking = controller.reBookingData!;
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        onPressed: () {
                           reebookingController.generatePdf();
                        },
                        icon: const Icon(

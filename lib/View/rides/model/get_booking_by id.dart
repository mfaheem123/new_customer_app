...
// //
// //     final getBookingById = getBookingByIdFromJson(jsonString);
//
// import 'dart:convert';
//
// GetBookingById getBookingByIdFromJson(String str) => GetBookingById.fromJson(json.decode(str));
//
// String getBookingByIdToJson(GetBookingById data) => json.encode(data.toJson());
//
...
//   });
//
//   factory GetBookingById.fromJson(Map<String, dynamic> json) => GetBookingById(

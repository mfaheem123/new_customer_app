...
//
//     final bookingGetById = bookingGetByIdFromJson(jsonString);

import 'dart:convert';

BookingGetById bookingGetByIdFromJson(String str) => BookingGetById.fromJson(json.decode(str));

String bookingGetByIdToJson(BookingGetById data) => json.encode(data.toJson());

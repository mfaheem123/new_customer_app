...
//
//     final airportList = airportListFromJson(jsonString);

import 'dart:convert';

AirportList airportListFromJson(String str) => AirportList.fromJson(json.decode(str));

String airportListToJson(AirportList data) => json.encode(data.toJson());
...
class AirportList {
  ...
  factory AirportList.fromJson(Map<String, dynamic> json) => AirportList(
    status: json["status"],
    count: json["count"],
